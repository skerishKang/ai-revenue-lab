/*  tutorial-data.js  —  방림명지로드힐 운영 데모 fixture (UMD)
 *
 *  Mirrors data/tutorial-data.json exactly (tests assert equality).
 *  실제 단지 정체성을 사용하며(방림명지로드힐아파트 · 101동·102동 · 192세대 ·
 *  제5기 입주자대표회의 · 회장 김경애), 데모용 예시 값만 데모 예시로 표시합니다.
 *  실제 주민·소송·고소·CCTV·투표 결과 데이터는 사용하지 않습니다.
 *  법률 판정 표현을 사용하지 않습니다.
 */
...
(function (root, factory) {
  ...
  return {
    meta: {
      title: "방림명지로드힐 우리단지 운영실",
      subtitle: "회의·공고·정족수·의견·의결·공개 기록을 주민이 이해할 수 있게 연결하는 단계별 운영 가이드",
      community: "방림명지로드힐아파트",
      communityEn: "Bangnim Myeongji Roadhill Apartment",
      region: "광주광역시 남구",
      buildings: "101동 · 102동",
      households: 192,
      council: "제5기 입주자대표회의",
      chair: "회장 김경애",
      demoNote: "방림명지로드힐 운영 데모입니다. 데모용으로 작성한 문서 내용과 예시 값은 실제 확정 자료가 아닙니다. 개인정보 포함 자료는 공개 전 검토·가림처리하며, 회의·공개·의결은 담당자 확인 후 확정됩니다. 전자투표·계약·결제 기능은 현재 데모 범위가 아닙니다."
    },
    chapters: [
      {
      ...
      },
      {
        ...
        steps: [
          { id: "roles-1", title: "역할 확인", text: "입주자대표회의 회장·동대표·감사·선거관리위원장·관리소장·관리사무소 담당자·일반 주민·외부 검토자 역할을 확인합니다." },
    ...
    scenarios: [
      { id: "normal", title: "정상 회의", text: "방림명지로드힐 제5기 입주자대표회의 회의가 준비·공고·출석·정족수·의결·후속조치·공개까지 정상 흐름으로 진행됩니다.", status: "기록 유지", demo: true },
      { id: "quorum_miss", title: "정족수 미달", text: "회의 출석이 정족수 기준에 미달하면 절차 보완 필요로 표시하고 재소집 공고를 안내합니다.", status: "절차 보완 필요", demo: true },
      { id: "evidence_missing", title: "소명자료 누락", text: "소명자료가 누락되면 자료 부족으로 표시하고 추가 제출을 안내합니다.", status: "자료 부족", demo: true },
      { id: "conflict", title: "이해관계 확인 필요", text: "이해관계가 의심되면 확인 필요로 표시하고 전문 검토 필요로 안내합니다.", status: "확인 필요", demo: true },
      { id: "dissent", title: "반대 의견 존재", text: "반대 의견은 의결과 함께 기록으로 보존하고 기록 유지합니다.", status: "기록 유지", demo: true },
      { id: "disclosure_hold", title: "주민 공개 보류", text: "공개가 적절하지 않으면 공개 보류로 표시하고 전문 검토 필요로 안내합니다.", status: "공개 보류", demo: true },
      { id: "overdue", title: "기한초과 후속조치", text: "후속조치 기한이 지나면 기록 유지로 표시하고 후속 조치를 안내합니다.", status: "기록 유지", demo: true }
    ]
  };
});
