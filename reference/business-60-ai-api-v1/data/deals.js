window.B60_DEALS = [
  {
    id: 'vercel-glm52-fx-202608',
    provider: 'Vercel',
    model: 'GLM 5.2',
    modelId: 'zai/glm-5.2',
    accessSurface: 'fx / AI Gateway signal',
    headline: 'GLM 5.2 access signal',
    promoClaim: 'Free on fx through 2026-08-27',
    promoVerification: 'PENDING_WEB_VERIFICATION',
    verifiedFacts: [
    ...
    fxFacts: [
      'fx is an open-source coding agent from Vercel Labs.',
      'fx supports Vercel sign-in and AI Gateway API-key setup.'
    ],
