...
STATES=['cover', 'context', 'routes', 'evidence', 'constraints', 'handoff', 'mobile']
HANDOFF='handoff'
BOARD='[data-route-trace]'
SEAL='.route-brief-seal'
...
async def run():
    ...
    async with async_playwright() as p:
        ...
        for state,path in {'cover': '/mnt/data/business37-cover.png', 'routes': '/mnt/data/business37-routes.png', 'handoff': '/mnt/data/business37-handoff.png', 'mobile': '/mnt/data/business37-mobile.png'}.items():
