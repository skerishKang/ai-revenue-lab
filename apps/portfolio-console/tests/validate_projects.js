...
function validate() {
  ...
  assert(totalDone === 11, `Expected exactly 11 done tasks, got ${totalDone}`);
  assert(totalTasks - totalDone === 14, `Expected exactly 14 remaining tasks, got ${totalTasks - totalDone}`);
