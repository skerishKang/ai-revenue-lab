...
(function () {
  ...
  function identity(data) {
    ...
    return {
      ...
      portfolioClass: data.pc || "internal", boundaryKind: data.bk || null,
  ...
  window.ARL_MANIFEST = [
    ...
    // ═══ 5–12 ═══
    identity({ n:5, s:"neighbor-market", t:"Neighbor Market", k:"우리단지 이웃가게", a:NA.CANONICAL, l:"expanded_successor", st:"external", p:95, w:"skerishKang/02-danji-on", pc:"expanded-successor", bk:"expanded-successor", sn:"DanjiOn", sk:"단지온", sr:"https://github.com/skerishKang/02-danji-on" }),
    identity({ n:6, s:"world-feed", t:"World Feed", k:"월드 피드", a:NA.CANONICAL, l:"research", st:"review", p:88, su:"https://ai-revenue-final-review-b06.pages.dev/", w:"apps/world-feed/" }),
    identity({ n:7, s:"personal-meaning-map", t:"Personal Meaning Map", k:"개인 의미 지도", a:NA.CANONICAL, l:"visual_reference", st:"review", p:65, su:"https://ai-revenue-final-review-b07.pages.dev/", w:"reference/business-07-personal-meaning-map-v1/" }),
    identity({ n:8, s:"family-newspaper", t:"Family Newspaper", k:"우리 가족 신문", a:NA.CANONICAL, l:"visual_reference", st:"review", p:60, su:"https://ai-revenue-final-review-b08.pages.dev/", w:"reference/business-08-family-newspaper-v1/" }),
    identity({ n:9, s:"personalized-childrens-story", t:"Personalized Children’s Story", k:"우리 아이 이야기", a:NA.CANONICAL, l:"visual_reference", st:"review", p:58, su:"https://ai-revenue-final-review-b09.pages.dev/", w:"reference/business-09-personalized-childrens-story-v1/" }),
    ...
    identity({ n:11, s:"language-learning-magazine", t:"Language Learning Magazine", k:"나의 언어학습 매거진", a:NA.CANONICAL, l:"visual_reference", st:"review", p:54, su:"https://ai-revenue-final-review-b11.pages.dev/", w:"reference/business-11-language-learning-magazine-v1/" }),
    ...
    // ═══ 23–25 external implementation ═══
    identity({ n:23, s:"lovebud", t:"LoveBud", k:"러브버드", a:NA.EXISTING_PROJECT, l:"external_implementation", st:"external", p:45, su:"https://lovebud.pages.dev/", w:"skerishKang/LoveBud", pc:"expanded-successor", bk:"external-implementation", sn:"LoveBud", sk:"LoveBud", sr:"https://github.com/skerishKang/LoveBud" }),
    identity({ n:24, s:"lovetree-3", t:"LoveTree 3.0", k:"러브트리 3.0", a:NA.EXISTING_PROJECT, l:"external_implementation", st:"external", p:25, su:"https://lovetree3.pages.dev/", w:"skerishKang/lovetree3.0", pc:"expanded-successor", bk:"external-implementation", sn:"LoveTree 3.0", sk:"LoveTree 3.0", sr:"https://github.com/skerishKang/lovetree3.0" }),
    identity({ n:25, s:"love-matchmaking", t:"Love Matchmaking", k:"러브 매치메이킹", a:NA.EXISTING_PROJECT, l:"external_implementation", st:"external", p:15, w:"skerishKang/401-love-match-making", pc:"expanded-successor", bk:"external-implementation", sn:"Love Matchmaking", sk:"러브 매치메이킹", sr:"https://github.com/skerishKang/401-love-match-making" }),
    // ═══ 26–35 ═══
    identity({ n:26, s:"company-memory", t:"Company Memory", k:"회사 기억", a:NA.PROPOSED, l:"integrated_successor", st:"external", p:27, pc:"expanded-successor", bk:"integrated-successor", sn:"Ieeon", sk:"이어온" }),
    identity({ n:27, s:"evidence-studio", t:"Evidence Studio", k:"사건 기록실", a:NA.PROPOSED, l:"integrated_successor", st:"external", p:26, pc:"expanded-successor", bk:"integrated-successor", sn:"Sasillo", sk:"사실로" }),
    identity({ n:28, s:"decision-archive", t:"Decision Archive", k:"회의·결정 기록실", a:NA.PROPOSED, l:"integrated_successor", st:"external", p:24, pc:"expanded-successor", bk:"integrated-successor", sn:"Ieeon", sk:"이어온" }),
    ...
    identity({ n:30, s:"civic-ai-navigator", t:"Civic AI Navigator", k:"시민 AI 내비게이터", a:NA.PROPOSED, l:"expanded_successor", st:"external", p:20, w:"skerishKang/400-ai-finder", pc:"expanded-successor", bk:"expanded-successor", sn:"400 AI Finder", sk:"400-ai-finder", sr:"https://github.com/skerishKang/400-ai-finder" }),
    identity({ n:31, s:"public-procedure-experience-data", t:"Public Procedure Experience Data", k:"공공절차 경험 데이터", a:NA.PROPOSED, l:"integrated_successor", st:"external", p:18, pc:"expanded-successor", bk:"integrated-successor", sn:"Sasillo", sk:"사실로" }),
    ...
    // ═══ 60 ═══
    identity({ n:60, s:"ai-api", t:"AI API", k:"AI API 탐색 허브", a:NA.PROPOSED, l:"private_preview", st:"review", p:90, su:"https://ai-revenue-portfolio-console.pages.dev/ai-api/", w:"reference/business-60-ai-api-v1/" }),
  ];
