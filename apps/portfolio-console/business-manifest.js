...
(function () {
  ...
  window.ARL_MANIFEST = [
    ...
    identity({ n:6, s:"world-feed", t:"World Feed", k:"월드 피드", a:NA.RECONCILIATION, l:"research", st:"planning", p:88, w:"apps/world-feed/" }),
    // ═══ 7–12: PROPOSED ═══
    ...
    identity({ n:29, s:"apartment-governance", t:"Apartment Governance", k:"우리단지 운영실", a:NA.PROPOSED, l:"visual_reference", st:"review", p:22, w:"reference/business-29-apartment-governance-v1/" }),
    ...
    identity({ n:32, s:"ai-skill-studio", t:"AI Skill Studio", k:"AI 업무 실습실", a:NA.PROPOSED, l:"visual_reference", st:"review", p:16, w:"reference/business-32-ai-skill-studio-v1/" }),
    ...
    identity({ n:35, s:"ai-media-education-dx", t:"AI Media Education & DX", k:"AI 미디어 교육\u00b7DX", a:NA.PROPOSED, l:"visual_reference", st:"review", p:11, w:"reference/business-35-ai-media-education-dx-v1/" }),
    // ═══ 36–43: PROPOSED ═══
    ...
    identity({ n:38, s:"ai-learning-tutor", t:"AI Learning Tutor", k:"AI 학습 튜터", a:NA.PROPOSED, l:"visual_reference", st:"review", p:46, w:"reference/business-38-ai-learning-tutor-v1/" }),
    ...
    identity({ n:48, s:"ai-verification-engine", t:"AI Verification Engine", k:"AI 검증\u00b7승인 엔진", a:NA.CANDIDATE, l:"concept", st:"planning", p:5 }),
    identity({ n:49, s:"public-data-connector-hub", t:"Public Data Connector Hub", k:"공공데이터 커넥터 허브", a:NA.CANDIDATE, l:"concept", st:"planning", p:5 }),
