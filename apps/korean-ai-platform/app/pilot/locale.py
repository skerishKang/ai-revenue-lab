...
_t("start.key_missing", "API key 없음 — .env에 OPENROUTER_API_KEY 설정 필요", "No API key - set OPENROUTER_API_KEY in .env")
...
_t("start.no_key_live", "Live 모드에서는 OPENROUTER_API_KEY가 필요합니다. .env 파일에 키를 설정하십시오.", "Live mode requires OPENROUTER_API_KEY. Set it in .env.")
