...
| `living-travel` | 2 | Implemented private MVP; production foundation open | Travel content becomes more valuable when each edition adapts to the traveler's latest interests and situation. | Shared Firebase identity foundation is specified; portal integration is not implemented. |
...
| `living-learning` | 4 | Adaptive-learning MVP and static UI work | A recurring short learning publication becomes more useful when it adapts to the learner's responses. | Not integrated. |
...
| `personal-video-archive` | 13 | Incubation MVP; bilingual redesign in Draft PR #78 | Users will return to user-controlled topic feeds when video discovery is cleaner and watched videos become durable private reflections and plans. | Global portal shell must be added before final integration. |
