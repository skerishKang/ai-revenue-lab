...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "home_intro_title": {
        "ko": "흩어진 영상을 주제별로 모으고, 나만의 기록으로 남기세요",
        "en": "Gather scattered videos by topic and keep them as your own record",
    },
    "home_intro_desc": {
        "ko": "관심 주제를 등록하면 AI가 관련 영상을 찾아줍니다. 본 영상에는 나만의 메모와 회고를 남겨 다시 꺼내 보세요.",
        "en": "Register a topic and the AI finds related videos. Leave notes and reflections on what you watch, then resurface them later.",
    },
    "home_hero_label": {"ko": "오늘의 추천", "en": "Featured today"},
    "home_continue_label": {"ko": "이어 보기", "en": "Continue watching"},
    "home_continue_progress": {"ko": "진행률", "en": "Progress"},
    "home_memory_label": {"ko": "지난 기록에서", "en": "From a past note"},
    "home_memory_more": {"ko": "기록 열기", "en": "Open record"},
    "home_discover_label": {"ko": "새로 발견한 영상", "en": "New finds"},
    "home_discover_desc": {
        "ko": "등록한 주제에서 AI가 새로 찾아낸 영상입니다.",
        "en": "Videos the AI newly found across your topics.",
    },
    "home_collections_label": {"ko": "주제", "en": "Topics"},
    "home_collections_desc": {
        "ko": "주제별로 영상을 모아 관리합니다.",
        "en": "Collect and manage videos by topic.",
    },
    "home_collection_videos": {"ko": "영상 {n}개", "en": "{n} videos"},
    "home_notes_label": {"ko": "나의 기록", "en": "My notes"},
    "home_notes_desc": {
        "ko": "최근에 남긴 시청 기록입니다.",
        "en": "Your most recent viewing notes.",
    },
    "home_resurfaced_label": {"ko": "다시 떠오른 기록", "en": "Resurfaced"},
    "home_resurfaced_desc": {
        "ko": "다시 볼 시점이 된 지난 기록을 꺼냈습니다.",
        "en": "A past note worth revisiting has resurfaced.",
    },
    "home_resurfaced_action": {"ko": "기록 다시 보기", "en": "Revisit record"},
    "home_match_score": {"ko": "매칭 {score}%", "en": "match {score}%"},
    # --- Feed (reference port) -------------------------------------------
    "feed_rule_label": {"ko": "검색 규칙", "en": "Search rules"},
    "feed_rule_primary": {"ko": "기본 검색어", "en": "Primary query"},
    "feed_rule_related": {"ko": "관련 검색어", "en": "Related queries"},
    "feed_rule_required": {"ko": "필수 포함", "en": "Required terms"},
    "feed_rule_excluded": {"ko": "제외", "en": "Excluded terms"},
    "feed_rule_duration": {"ko": "길이", "en": "Duration"},
    "feed_rule_shorts": {"ko": "쇼츠", "en": "Shorts"},
    "feed_rule_sort": {"ko": "정렬", "en": "Sort"},
    "feed_rule_languages": {"ko": "언어", "en": "Languages"},
    "feed_rule_none": {
        "ko": "아직 검색 규칙이 없습니다.",
        "en": "No search rule yet.",
    },
    "feed_more": {"ko": "자세히", "en": "More"},
    "feed_open_record": {"ko": "기록 열기", "en": "Open record"},
    # --- Record (reference port) -----------------------------------------
    "record_section_note": {"ko": "원본 메모", "en": "Original note"},
    "record_section_reflection": {"ko": "회고", "en": "Reflection"},
    "record_section_learned": {"ko": "배운 점", "en": "What I learned"},
    "record_section_thinking": {"ko": "생각 정리", "en": "Structured thinking"},
    "record_section_agreement": {"ko": "동의", "en": "Agreement"},
    "record_section_disagreement": {"ko": "다른 의견", "en": "Disagreement"},
    "record_section_uncertainty": {"ko": "불확실한 부분", "en": "Uncertainty"},
    "record_section_followup": {"ko": "후속 계획", "en": "Follow-up plan"},
    "record_section_ai": {"ko": "AI 정리 제안", "en": "AI suggestion"},
    "record_side_source": {"ko": "연결된 영상", "en": "Linked video"},
    "record_side_facts": {"ko": "기록 정보", "en": "Record details"},
    "record_side_state": {"ko": "시청 상태", "en": "Viewing state"},
    "record_side_rating": {"ko": "평점", "en": "Rating"},
    "record_side_opened": {"ko": "처음 연 날짜", "en": "Opened"},
    "record_side_completed": {"ko": "완료 날짜", "en": "Completed"},
    "record_side_tags": {"ko": "태그", "en": "Tags"},
    "record_side_timestamps": {"ko": "타임스탬프", "en": "Timestamps"},
    "record_edit": {"ko": "기록 편집", "en": "Edit record"},
    "record_save": {"ko": "기록 저장", "en": "Save record"},
    "record_ai_desc": {
        "ko": "AI가 메모를 구조화된 기록으로 정리했습니다. 수락하면 아래 항목에 반영됩니다.",
        "en": "The AI structured your note. Accepting applies it to the fields below.",
    },
    "record_no_note": {
        "ko": "아직 원본 메모가 없습니다.",
        "en": "No original note yet.",
    },
    "record_no_reflection": {"ko": "아직 회고가 없습니다.", "en": "No reflection yet."},
    "record_no_learned": {"ko": "아직 배운 점이 없습니다.", "en": "Nothing learned yet."},
    "record_no_agreement": {"ko": "기록이 없습니다.", "en": "Not recorded."},
    "record_no_disagreement": {"ko": "기록이 없습니다.", "en": "Not recorded."},
    "record_no_uncertainty": {"ko": "기록이 없습니다.", "en": "Not recorded."},
    "record_no_followup": {"ko": "아직 후속 계획이 없습니다.", "en": "No follow-up plan yet."},
    "record_no_timestamps": {
        "ko": "저장된 타임스탬프가 없습니다.",
        "en": "No timestamps saved.",
    },
    "record_no_tags": {"ko": "태그 없음", "en": "No tags"},
    "record_no_rating": {"ko": "미평가", "en": "Not rated"},
    "record_no_date": {"ko": "—", "en": "—"},
    "record_rating_value": {"ko": "{n}/5", "en": "{n}/5"},
    "record_edit_form_title": {"ko": "기록 편집", "en": "Edit record"},
    # --- Topics -----------------------------------------------------------
