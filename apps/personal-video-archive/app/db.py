...
Adapted from the personal-edition workspace pattern but fully self-contained
within this workspace.  No shared code is used.
"""
...
def _run_python_migration(path: Path, conn: sqlite3.Connection) -> None:
    module_name = "pva_migration_" + path.stem
