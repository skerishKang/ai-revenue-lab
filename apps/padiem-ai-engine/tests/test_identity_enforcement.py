...
@pytest.mark.parametrize(
    ...
    [
        ...
        '{"version":1,"callers":[{"caller_id":"caller-a","credential":"' + "A" * 48 + '","allowed_app_ids":"app-a"}]}',
        '{"version":1,"callers":[{"caller_id":"caller-a","credential":"' + "A" * 48 + '","allowed_app_ids":"abc"}]}',
        '{"version":1,"callers":[{"caller_id":"caller-a","credential":"' + "A" * 48 + '","allowed_app_ids":null}]}',
        '{"version":1,"callers":[{"caller_id":"caller-a","credential":"' + "A" * 48 + '","allowed_app_ids":123}]}',
        'null',
        '[]',
        '{"version":1,"callers":[1]}',
    ],
