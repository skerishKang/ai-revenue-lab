(() => {
  ...
  const labels = {
    ko: {
      ...
      "claw-meta-summary": "출처 · 거래처 (선택)", "claw-result-badge": "미리보기", "claw-result-open": "문서 열기", "claw-result-docx": "DOCX 다운로드", "claw-result-note": "백엔드 연결 전까지 미리보기 텍스트만 표시됩니다.",
    ...
    en: {
      ...
      "claw-meta-summary": "Source · counterparty (optional)", "claw-result-badge": "Preview", "claw-result-open": "Open document", "claw-result-docx": "Download DOCX", "claw-result-note": "Only preview text is shown until the backend is connected.",
