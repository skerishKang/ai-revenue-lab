(() => {
  ...
  const labels = {
    ko: {
      ...
      "calendar-kicker": "PADIEM CALENDAR", "calendar-title": "캘린더", "calendar-help": "오늘 예정된 항목과 다가오는 항목을 보여줍니다. 업무 기록과 일정(예약)을 직접 만들 수 있고, 일정 수정·삭제는 아직 지원하지 않습니다.", "calendar-refresh-aria": "목록 새로고침", "calendar-tabs-aria": "캘린더 보기 선택", "calendar-today": "오늘", "calendar-upcoming": "예정",
      "calendar-loading": "불러오는 중…", "calendar-error": "캘린더를 불러오지 못했습니다. 다시 시도해 주세요.", "calendar-empty-today": "오늘 예정된 항목이 없습니다.", "calendar-empty-upcoming": "다가오는 항목이 없습니다.", "calendar-all-day": "종일",
