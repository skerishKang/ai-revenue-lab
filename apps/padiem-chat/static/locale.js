(() => {
  ...
  const labels = {
    ko: {      "claw-compare-table-caption": "공급업체별 비교 결과. 순위 칸의 숫자는 등수이며, 비어 있으면 미확인입니다.",

      "claw-btn-compare": "견적 비교",
      "claw-compare-kicker": "PADIEM CLAW",
      "claw-compare-title": "공급업체 견적 비교",
      "claw-compare-close-aria": "비교 패널 닫기",
      "claw-compare-tagline": "업체별 견적 항목을 직접 입력하면 가격·납기·결제조건을 정해진 규칙으로만 계산합니다. 값이 비어 있으면 추측하지 않고 미확인으로 남깁니다.",
      "claw-compare-help": "결과는 참고용이며, 협상 문구는 초안으로만 만들어집니다. 전송·발주·구매는 이 화면에서 수행되지 않습니다.",
      "claw-compare-form-aria": "공급업체 견적 입력",
      "claw-compare-mode-label": "비교 기준",
      "claw-compare-mode-balanced": "균형 (가격·납기·결제)",
      "claw-compare-mode-price": "최저가",
      "claw-compare-mode-delivery": "최단 납기",
      "claw-compare-mode-cashflow": "현금흐름 유리",
      "claw-compare-currency-label": "통화",
      "claw-compare-docx": "DOCX 만들기 (선택)",
      "claw-compare-add": "공급업체 추가",
      "claw-compare-submit": "비교하기",
      "claw-compare-loading": "비교 중…",
      "claw-cmp-row-title": "공급업체",
      "claw-cmp-supplier": "업체명",
      "claw-cmp-item": "품목",
      "claw-cmp-quantity": "수량",
      "claw-cmp-unit": "단가",
      "claw-cmp-total": "총액",
      "claw-cmp-delivery": "납기 예정일",
      "claw-cmp-terms": "결제조건 문구",
      "claw-cmp-due-days": "만기일 (일)",
      "claw-cmp-prepaid": "선급",
      "claw-cmp-evidence": "근거 참조 (선택)",
      "claw-cmp-remove": "이 항목 삭제",
      "claw-cmp-unknown": "미확인",
      "claw-cmp-none": "없음",
      "claw-cmp-prepaid-yes": "선급",
      "claw-cmp-col-supplier": "업체",
      "claw-cmp-col-total": "총액",
      "claw-cmp-col-delivery": "납기",
      "claw-cmp-col-terms": "결제조건",
      "claw-cmp-col-price-rank": "가격 순위",
      "claw-cmp-col-delivery-rank": "납기 순위",
      "claw-cmp-col-cashflow-rank": "현금흐름 순위",
      "claw-cmp-col-score": "점수",
      "claw-cmp-col-unknown": "미확인 항목",
      "claw-cmp-recommendation": "추천",
      "claw-cmp-axis-price": "최저가 업체",
      "claw-cmp-axis-delivery": "최단 납기 업체",
      "claw-cmp-axis-cashflow": "현금흐름 유리 업체",
      "claw-cmp-unknown-note": "미확인으로 남은 업체:",
      "claw-cmp-unknown-none": "모든 업체 항목이 확인되었습니다.",
      "claw-cmp-negotiation": "협상 초안",
      "claw-cmp-negotiation-note": "이 문구는 초안입니다. 자동 발송되지 않으며, 보내기·발주·구매 권한은 없습니다.",
      "claw-cmp-negotiation-none": "협상 초안은 비교 가능한 상대 견적이 있을 때만 만들어집니다.",
      "claw-cmp-target-supplier": "대상 업체",
      "claw-cmp-current": "현재 총액",
      "claw-cmp-target": "목표 총액",
      "claw-cmp-basis": "산출 근거",
      "claw-cmp-advisory": "결과는 입력값만으로 계산된 참고용 판단입니다.",
      "claw-cmp-card-kind": "공급업체 견적 비교",
      "claw-cmp-card-summary": "저장된 비교 문서",
      "claw-cmp-status-success": "비교 결과가 준비되었습니다.",
      "claw-cmp-error-min": "두 곳 이상의 업체 견적을 입력해 주세요.",
      "claw-cmp-error-count": "비교할 견적 항목 수를 확인해 주세요.",
      "claw-cmp-error-price": "금액 항목을 확인해 주세요. 단가·총액은 정수로 입력합니다.",
      "claw-cmp-error-date": "납기 예정일은 YYYY-MM-DD 형식의 날짜로 입력해 주세요.",
      "claw-cmp-error-quantity": "수량 항목을 확인해 주세요.",
      "claw-cmp-error-terms": "결제조건 항목을 확인해 주세요.",
      "claw-cmp-error-currency": "통화는 세 자리 코드로, 모든 업체가 같은 통화로 입력해 주세요.",
      "claw-cmp-error-mode": "선택한 비교 기준을 다시 확인해 주세요.",
      "claw-cmp-error-scope": "문서를 저장하려면 로그인 세션이 필요합니다.",
      "claw-cmp-error-generic": "비교를 완료하지 못했습니다. 입력을 확인한 뒤 다시 시도해 주세요.",
      "claw-cmp-error-offline": "서버와 연결하지 못했습니다. 잠시 후 다시 시도해 주세요.",
    ...
    en: {      "claw-compare-table-caption": "Comparison result per supplier. The rank columns hold positions, and an empty capture is reported as unknown.",

      "claw-btn-compare": "Compare quotes",
      "claw-compare-kicker": "PADIEM CLAW",
      "claw-compare-title": "Supplier quote comparison",
      "claw-compare-close-aria": "Close comparison panel",
      "claw-compare-tagline": "Enter each supplier's captured quote and the price, delivery and payment terms are compared by fixed rules only. A field you leave empty stays unknown instead of being filled in.",
      "claw-compare-help": "Results are for reference and any negotiation text is produced as a draft only. Nothing is sent, ordered or purchased from this screen.",
      "claw-compare-form-aria": "Supplier quote entry",
      "claw-compare-mode-label": "Comparison basis",
      "claw-compare-mode-balanced": "Balanced (price · delivery · payment)",
      "claw-compare-mode-price": "Lowest price",
      "claw-compare-mode-delivery": "Fastest delivery",
      "claw-compare-mode-cashflow": "Best cash-flow fit",
      "claw-compare-currency-label": "Currency",
      "claw-compare-docx": "Create DOCX (optional)",
      "claw-compare-add": "Add supplier",
      "claw-compare-submit": "Compare",
      "claw-compare-loading": "Comparing…",
