(() => {
  ...
  const labels = {
    ko: {
      ...
      "claw-inbox-kicker": "PADIEM CLAW", "claw-inbox-title": "작업 및 알림", "claw-inbox-tagline": "저장된 작업과 알림을 확인합니다. 자동 실행이나 외부 전송은 하지 않습니다.", "claw-inbox-aria": "작업 및 알림함", "claw-inbox-refresh-aria": "목록 새로고침", "claw-inbox-loading": "불러오는 중…", "claw-inbox-empty": "표시할 작업이나 알림이 없습니다.", "claw-inbox-tasks-title": "작업", "claw-inbox-alerts-title": "알림", "claw-inbox-retry": "다시 시도", "claw-inbox-status": "상태", "claw-inbox-created": "생성", "claw-inbox-due": "마감", "claw-inbox-severity": "중요도", "claw-inbox-kind": "종류", "claw-inbox-error-auth": "로그인이 필요합니다.", "claw-inbox-error-unavailable": "작업/알림 목록을 사용할 수 없습니다.", "claw-inbox-error-not-found": "항목을 찾을 수 없습니다.", "claw-inbox-error-generic": "작업/알림을 처리할 수 없습니다.",
      "claw-task-status-open": "열림", "claw-task-status-done": "완료", "claw-task-status-cancelled": "취소됨", "claw-alert-status-active": "표시 중", "claw-alert-status-dismissed": "숨김",
      "claw-alert-severity-info": "정보", "claw-alert-severity-warn": "주의", "claw-alert-severity-critical": "중요",
      "claw-alert-kind-followup_due": "후속 일정", "claw-alert-kind-price_change": "가격 변동", "claw-alert-kind-unresolved_request": "미해결 요청", "claw-alert-kind-memory_proposal": "메모리 제안",
      "claw-inbox-mark-done": "완료로 표시", "claw-inbox-reopen": "다시 열기", "claw-inbox-cancel-task": "취소로 표시", "claw-inbox-dismiss-alert": "숨기기", "claw-inbox-restore-alert": "다시 표시",
    ...
    en: {
      ...
      "claw-inbox-kicker": "PADIEM CLAW", "claw-inbox-title": "Tasks and alerts", "claw-inbox-tagline": "Review saved tasks and alerts. Nothing runs automatically and nothing is sent externally.", "claw-inbox-aria": "Task and alert inbox", "claw-inbox-refresh-aria": "Refresh list", "claw-inbox-loading": "Loading…", "claw-inbox-empty": "No tasks or alerts to show.", "claw-inbox-tasks-title": "Tasks", "claw-inbox-alerts-title": "Alerts", "claw-inbox-retry": "Try again", "claw-inbox-status": "Status", "claw-inbox-created": "Created", "claw-inbox-due": "Due", "claw-inbox-severity": "Severity", "claw-inbox-kind": "Kind", "claw-inbox-error-auth": "Please sign in.", "claw-inbox-error-unavailable": "The task/alert list is unavailable.", "claw-inbox-error-not-found": "The item was not found.", "claw-inbox-error-generic": "Tasks and alerts could not be processed.",
      "claw-task-status-open": "Open", "claw-task-status-done": "Done", "claw-task-status-cancelled": "Cancelled", "claw-alert-status-active": "Active", "claw-alert-status-dismissed": "Dismissed",
      "claw-alert-severity-info": "Info", "claw-alert-severity-warn": "Warning", "claw-alert-severity-critical": "Critical",
      "claw-alert-kind-followup_due": "Follow-up due", "claw-alert-kind-price_change": "Price change", "claw-alert-kind-unresolved_request": "Unresolved request", "claw-alert-kind-memory_proposal": "Memory proposal",
      "claw-inbox-mark-done": "Mark done", "claw-inbox-reopen": "Reopen", "claw-inbox-cancel-task": "Mark cancelled", "claw-inbox-dismiss-alert": "Dismiss", "claw-inbox-restore-alert": "Restore",
