(() => {
  ...
  const labels = {
    ko: {
      ...
      "calendar-kicker": "PADIEM CALENDAR", "calendar-title": "캘린더", "calendar-help": "오늘 예정된 항목과 다가오는 항목을 보여줍니다. 업무 기록은 직접 남길 수 있고, 일정(예약) 생성·수정은 아직 지원하지 않습니다.", "calendar-refresh-aria": "목록 새로고침", "calendar-tabs-aria": "캘린더 보기 선택", "calendar-today": "오늘", "calendar-upcoming": "예정",
    ...
    en: {
      ...
      "calendar-kicker": "PADIEM CALENDAR", "calendar-title": "Calendar", "calendar-help": "Shows today's and upcoming items. You can add a work record yourself; creating or editing appointments is not supported yet.", "calendar-refresh-aria": "Refresh list", "calendar-tabs-aria": "Calendar view selection", "calendar-today": "Today", "calendar-upcoming": "Upcoming",
