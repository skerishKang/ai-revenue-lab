(() => {
  ...
  const labels = {
    ko: {
      ...
      "claw-runs-download": "문서 다시 받기", "claw-runs-open-session": "세션 열기", "claw-runs-status-completed": "완료",
    ...
    en: {
      ...
      "claw-runs-download": "Download document again", "claw-runs-open-session": "Open session", "claw-runs-status-completed": "Completed",
