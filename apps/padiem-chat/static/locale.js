(() => {
  ...
  const labels = {
    ko: {
      ...
      "calendar-kicker": "PADIEM CALENDAR", "calendar-title": "캘린더", "calendar-help": "오늘과 다가오는 일정을 읽기 전용으로 보여줍니다. 이 화면에서는 일정을 만들거나 수정하지 않습니다.", "calendar-refresh-aria": "목록 새로고침", "calendar-tabs-aria": "캘린더 보기 선택", "calendar-today": "오늘", "calendar-upcoming": "예정",
      ...
      "calendar-item-work-log": "업무 기록", "calendar-item-appointment": "일정", "calendar-item-task": "작업", "calendar-item-alert": "알림", "calendar-item-claw-run": "Claw 실행", "calendar-item-automation-run": "자동화 실행", "calendar-item-unknown": "기타", "calendar-item-untitled": "제목 없음",
    ...
    en: {
      ...
      "calendar-kicker": "PADIEM CALENDAR", "calendar-title": "Calendar", "calendar-help": "Shows today and upcoming items read-only. Nothing can be created or changed on this screen.", "calendar-refresh-aria": "Refresh list", "calendar-tabs-aria": "Calendar view selection", "calendar-today": "Today", "calendar-upcoming": "Upcoming",
      ...
      "calendar-item-work-log": "Work log", "calendar-item-appointment": "Appointment", "calendar-item-task": "Task", "calendar-item-alert": "Alert", "calendar-item-claw-run": "Claw run", "calendar-item-automation-run": "Automation run", "calendar-item-unknown": "Other", "calendar-item-untitled": "Untitled",
