...
const sandbox = {
  ...
  __padiemLocale: { text: (k) => ({
    "claw-memory-review-title": "메모리 저장 후보 (승인 필요)",
    "claw-memory-approve": "승인",
    "claw-memory-reject": "거절",
    "claw-memory-detail": "상세",
    "claw-memory-close": "닫기",
    "claw-memory-error-generic": "승인 메모리 처리에 실패했습니다.",
  }[k] || k) },
