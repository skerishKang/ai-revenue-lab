...
def test_frontend_project_files_remain_text_only_while_chat_supports_ephemeral_documents():
    ...
    assert "PDF·Office 문서는 채팅에 한 번 첨부해 사용할 수 있습니다" in html
    assert 'accept="text/plain,text/markdown,text/csv,application/json,.txt,.md,.markdown,.csv,.json"' in html
