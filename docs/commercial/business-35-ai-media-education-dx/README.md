...
COMMERCIAL_SOURCE_RECONCILIATION=V3_1_ALIGNED (#1503)
CUSTOMER_PACKAGE_REGENERATION=PENDING (Lane B)
...
|---|---|---|
| `CURRENT_PRODUCT_AUTHORITY.md` | V3.1 commercial/product bridge | V3.1 ALIGNED (#370) |
| `01-one-page-offer.md` | 1-page source | V3.1 ALIGNED |
| `02-ten-page-proposal.md` | 10-page proposal source | V3.1 ALIGNED (10 pages) |
| `03-diagnostic-questionnaire.md` | Customer diagnostic questionnaire | V3.1 ALIGNED — 5-input mapping |
| `04-six-week-pilot-plan.md` | 6-week pilot delivery plan | V3.1 ALIGNED — delivery detail |
| `05-statement-of-work-draft.md` | Statement of Work draft | V3.1 ALIGNED · DRAFT · PROFESSIONAL LEGAL REVIEW REQUIRED |
| `06-risk-and-data-annex.md` | Risk/data handling annex | V3.1 ALIGNED · DRAFT · PROFESSIONAL LEGAL REVIEW REQUIRED |
| `07-kpi-measurement-framework.md` | KPI measurement framework | V3.1 ALIGNED |
| `08-customer-qualification-scorecard.md` | Customer qualification scorecard | V3.1 ALIGNED |
| `SOURCES.md` | Legal/policy/market source register | VERIFIED sources deep-linked |
| `tests/validate_sales_package.py` | Commercial consistency validator | V3.1 gate — do not read as legal/market acceptance |
