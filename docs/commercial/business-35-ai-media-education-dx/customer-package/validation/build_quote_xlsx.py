...
def build():
    ...
    rows = [
        ...
        ("표준 가격", "A 300만–800만원 (초기 300만–500만원) · B 디자인 파트너 1,000만–1,500만원 · B 표준 1,500만–2,500만원 · C 월 300만–600만원"),
    ...
    # ---- Offer sheets ----
    offers = {
        "Offer A": ("A · AI 업무전환 진단 워크숍", 3_000_000, 8_000_000, "표준 300만–800만원 / 초기 300만–500만원"),
        "Offer B": ("B · 6주 디자인 파트너 파일럿", 10_000_000, 15_000_000, "디자인 파트너 1,000만–1,500만원"),
