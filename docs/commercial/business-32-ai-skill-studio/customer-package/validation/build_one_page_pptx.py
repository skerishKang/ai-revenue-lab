...
t = s.shapes.add_textbox(Inches(0.5), Inches(0.24), Inches(12.4), Inches(0.45))
set_run(t.text_frame.paragraphs[0].add_run(),
        "Business 32 · AI 업무 스킬 전환 프로그램 — 10초 요약", size=16, bold=True, color=BLUE)
cap = s.shapes.add_textbox(Inches(0.5), Inches(0.6), Inches(12.4), Inches(0.3))
set_run(cap.text_frame.paragraphs[0].add_run(),
        "제안검토용 · 합성 샘플 기반 · 사람 검토와 승인 필수", size=11, color=GRAY)

rect(s, Inches(0.5), Inches(0.95), Inches(12.35), Inches(0.6), PAPER, line_color=BLUE,
     text="누구를 위한 것: 반복업무를 수행하는 조직과 팀", size=13, text_color=INK)
rect(s, Inches(0.5), Inches(1.63), Inches(12.35), Inches(0.6), PAPER, line_color=RED,
     text="문제: AI를 개인별·일회성으로 사용해 결과물 품질이 사람마다 다름", size=13, text_color=INK)
rect(s, Inches(0.5), Inches(2.31), Inches(12.35), Inches(0.6), PAPER, line_color=GREEN,
...
for i, (name, desc) in enumerate(offers):
    ...
    rect(s, left, Inches(3.0), Inches(4.0), Inches(1.2), BLUE if i == 1 else GRAY,
         text="", size=12)
    nb = s.shapes.add_textbox(left + Inches(0.2), Inches(3.14), Inches(3.6), Inches(0.4))
    set_run(nb.text_frame.paragraphs[0].add_run(), name, size=14, bold=True, color=WHITE)
    db = s.shapes.add_textbox(left + Inches(0.2), Inches(3.55), Inches(3.6), Inches(0.55))
    set_run(db.text_frame.paragraphs[0].add_run(), desc, size=12, color=WHITE)

rect(s, Inches(0.5), Inches(4.3), Inches(12.35), Inches(0.6), PAPER, line_color=ORANGE,
     text="첫 행동: 반복업무 1개를 Skill Discovery Worksheet으로 선정 (실제 파일 불필요)",
     size=13, text_color=INK)
rect(s, Inches(0.5), Inches(4.98), Inches(12.35), Inches(0.6), PAPER, line_color=YELLOW,
     text="가격은 가설입니다. 확정 가격이 아닙니다.", size=13, text_color=INK)
rect(s, Inches(0.5), Inches(5.66), Inches(12.35), Inches(0.6), PAPER, line_color=GREEN,
     text="사람 검토와 승인이 필수입니다. AI가 자동 승인하지 않습니다.", size=13, text_color=INK)

fb = s.shapes.add_textbox(Inches(0.5), Inches(6.5), Inches(12.3), Inches(0.35))
set_run(fb.text_frame.paragraphs[0].add_run(), FOOTER_COVER, size=10, color=GRAY)
