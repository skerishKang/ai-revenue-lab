...
| **Document Export** | Minimal valid OOXML DOCX package generator (.docx) using Python standard library | HWPX fail-closed (DOCUMENTED_DECISION); legacy binary HWP unsupported | #2016 / #2070 |
...
| **Chat Shell UI** | Padiem Chat Shell (#2062, #2075) | Freebuff / Web Dev | pps/padiem-chat/static/** | **IN PROGRESS (#2075)** |
| **Intake Flow** | Manual Intake Router (#2056) | Gemini / Web Dev | pps/korean-ai-code-agent/src/kagent/manual_intake.py | **MERGED (#2072)** |
| **Doc Export** | OOXML Exporter (#2016) | Gemini / Web Dev | pps/korean-ai-code-agent/src/kagent/document_export.py | **MERGED (#2070)** |
| **Automation** | Claw Automation (#2058) | Gemini / Web Dev | pps/korean-ai-code-agent/src/kagent/claw_automation.py | **MERGED (#2073)** |
| **Core Grants** | P01 Grant Seed (#2010) | Kilo / Web Dev | packages/padiem-ai-core/**, pps/padiem-ai-engine/** | **ACT-1 MERGED / ACT-2 IN PROGRESS** |
| **Memory** | Claw Memory & Tasks (#2057) | Parallel Local 1 | pps/korean-ai-code-agent/src/kagent/ | **IN PROGRESS (#2057)** |
