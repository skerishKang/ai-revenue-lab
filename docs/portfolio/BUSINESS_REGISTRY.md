...
| 2 | `living-travel` | Living Travel / 리빙 트래블 | `apps/living-travel/` | Implemented private MVP; production foundation open | Shared Firebase identity; Living Travel owns traveler/operator mapping and data access. | Not yet integrated; no portal implementation in Issue #74 | Issues #32, #43, #69, #74 |
...
| 4 | `living-learning` | Living Learning / 리빙 러닝 | `apps/living-learning/` | Isolated adaptive-learning MVP and static UI work | Current product-local/synthetic access contract; portfolio identity integration not yet implemented. | Not yet integrated | Issue #37 and current Business 4 project direction |
...
| 13 | `personal-video-archive` | Personal Video Archive / 나의 영상 아카이브 | `apps/personal-video-archive/` | Incubation MVP; Korean-first bilingual redesign in Draft PR #78 | Current MVP is synthetic/local and has no accepted production authentication. Product must own private viewing-record authorization when integrated. | Reference UI must be adjusted to show the global portal shell before final integration | Issues #60, #62, #72, #76; PR #78 |
